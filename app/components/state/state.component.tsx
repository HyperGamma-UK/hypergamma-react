...
//todo: fix so this is a generic class and the props can be declared on the sComponent so you get the same reference ability as the base Component (current implementation is a hack because I don't get the type system)
